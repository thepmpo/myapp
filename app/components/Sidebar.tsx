        ...
        <nav className="flex flex-col gap-1">
          <Link
            ...
            className={`flex items-center gap-2.5 pl-[10px] pr-3 py-2 rounded-lg border-l-2 text-sm ${
              isCommunity ? "border-accent text-accent font-bold" : "border-transparent text-ink-soft font-medium hover:bg-black/[0.03]"
            }`}
          >
          ...
          <Link
            href="/articles"
            className={`flex items-center gap-2.5 pl-[10px] pr-3 py-2 rounded-lg border-l-2 text-sm ${
              isBoard ? "border-accent text-accent font-bold" : "border-transparent text-ink-soft font-medium hover:bg-black/[0.03]"
            }`}
          >
