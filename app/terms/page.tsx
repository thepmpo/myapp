...
export default function TermsOfService() {
  return (
    <div style={{ maxWidth: 640, margin: "0 auto", padding: 40 }}>
      ...
      <section style={{ marginBottom: 20 }}>
        <h2 style={{ fontSize: 15, marginBottom: 8 }}>제2조 (용어의 정의)</h2>
        <p style={{ color: "#666" }}>
      ...
      <section style={{ marginBottom: 20 }}>
        <h2 style={{ fontSize: 15, marginBottom: 8 }}>제3조 (약관의 효력 및 변경)</h2>
        <p style={{ color: "#666" }}>
      ...
      <section style={{ marginBottom: 20 }}>
        <h2 style={{ fontSize: 15, marginBottom: 8 }}>제4조 (회원가입)</h2>
        <p style={{ color: "#666" }}>
      ...
      <section style={{ marginBottom: 20 }}>
        <h2 style={{ fontSize: 15, marginBottom: 8 }}>제5조 (회원의 의무)</h2>
        <p style={{ color: "#666" }}>
      ...
      <section style={{ marginBottom: 20 }}>
        <h2 style={{ fontSize: 15, marginBottom: 8 }}>제6조 (게시물의 관리)</h2>
        <p style={{ color: "#666" }}>
      ...
      <section style={{ marginBottom: 20 }}>
        <h2 style={{ fontSize: 15, marginBottom: 8 }}>제7조 (계정 및 탈퇴)</h2>
        <p style={{ color: "#666" }}>
      ...
      <section style={{ marginBottom: 20 }}>
        <h2 style={{ fontSize: 15, marginBottom: 8 }}>제8조 (면책조항)</h2>
        <p style={{ color: "#666" }}>
