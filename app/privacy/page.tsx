...
export default function PrivacyPolicy() {
  return (
    <div style={{ maxWidth: 640, margin: "0 auto", padding: 40 }}>
      ...
      <section style={{ marginBottom: 20 }}>
        <h2 style={{ fontSize: 15, marginBottom: 8 }}>4. 개인정보의 제3자 제공</h2>
        <p style={{ color: "#666" }}>
      ...
      <section style={{ marginBottom: 20 }}>
        <h2 style={{ fontSize: 15, marginBottom: 8 }}>5. 개인정보 처리의 위탁</h2>
        <p style={{ color: "#666" }}>
      ...
      <section style={{ marginBottom: 20 }}>
        <h2 style={{ fontSize: 15, marginBottom: 8 }}>6. 이용자의 권리와 행사 방법</h2>
        <p style={{ color: "#666" }}>
      ...
      <section style={{ marginBottom: 20 }}>
        <h2 style={{ fontSize: 15, marginBottom: 8 }}>7. 개인정보의 파기</h2>
        <p style={{ color: "#666" }}>
      ...
      <section style={{ marginBottom: 20 }}>
        <h2 style={{ fontSize: 15, marginBottom: 8 }}>8. 쿠키의 사용</h2>
        <p style={{ color: "#666" }}>
      ...
      <section style={{ marginBottom: 20 }}>
        <h2 style={{ fontSize: 15, marginBottom: 8 }}>9. 개인정보보호책임자</h2>
        <p style={{ color: "#666" }}>
      ...
      <section>
        <h2 style={{ fontSize: 15, marginBottom: 8 }}>10. 고지의 의무</h2>
        <p style={{ color: "#666" }}>
